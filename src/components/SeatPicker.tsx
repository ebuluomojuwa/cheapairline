...
export const SeatPicker: React.FC<SeatPickerProps> = ({
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-xl space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-slate-900">{flight.airline} Seat Map</h2>
          </div>
        ...
        {selectedSeatNumber ? (
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 p-3 rounded-2xl flex items-center gap-3">
            ...
            <div>
              <div className="text-xs text-amber-900 font-bold">Selected Seat</div>
          ...
          <div className="text-xs text-slate-500 bg-slate-50 px-3 py-2 rounded-xl border border-slate-200 flex items-center gap-2">
      ...
      {/* Legend */}
      <div className="flex flex-wrap items-center justify-center gap-3 text-xs bg-slate-50 p-3 rounded-2xl border border-slate-200">
      ...
      {/* Aircraft Shell */}
      <div className="relative max-w-md mx-auto bg-slate-100 border-2 border-slate-300 rounded-[50px] p-4 sm:p-6 shadow-inner space-y-6">
