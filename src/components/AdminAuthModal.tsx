      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden">
        ...
        <form onSubmit={handleVerify} className="p-6 space-y-5">
          <div className="space-y-2 text-slate-600 text-xs sm:text-sm">
            <p>
              The <strong>Admin & Front Desk Ticket Verification Portal</strong> is protected. Please enter your authorized staff passcode to grant gate passes and manage passenger manifests.
            </p>
          </div>

          {/* Keycard Hint */}
          <div className="bg-amber-50 border border-amber-200/80 p-3.5 rounded-2xl flex items-start gap-3">
            <KeyRound className="w-5 h-5 text-amber-600 shrink-0 mt-0.5" />
            <div className="text-xs text-amber-900">
              <span className="font-extrabold block">Authorized Administrator Access PIN:</span>
              <span className="font-mono font-black text-red-700 text-sm">1926</span> or <span className="font-mono font-black text-red-700 text-sm">AA8800</span>
            </div>
          </div>

          {error && (
            <div className="bg-rose-50 border border-rose-200 p-3 rounded-xl flex items-center gap-2 text-rose-700 text-xs font-bold animate-pulse">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-300 text-sm font-bold text-slate-900 focus:border-[#C41230] focus:ring-2 focus:ring-red-100 outline-none transition font-mono tracking-widest"
                autoFocus
              />
            </div>
          </div>
